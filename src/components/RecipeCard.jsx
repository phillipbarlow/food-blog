    ...
    <div className="group overflow-hidden rounded-xl shadow-md bg-white transition hover:-translate-y-1 hover:shadow-lg">
      <Link to={`/recipes/${id}`}>
        ...
        <div className="p-5 space-y-2">
          ...
          <section className="mt-3 inline-block bg-emerald-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-emerald-600 transition">View Recipe →</section>
